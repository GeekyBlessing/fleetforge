...
//
// Day 4 scope note: label-affinity hard filtering (also specified in doc
// 9.1) is not applied yet. Candidates here are exactly "READY, capable,
// spare capacity" -- narrowing further by job.Labels vs worker.Labels
// rules is a documented follow-up (docs/09-design-rationale.md), not
// silently dropped.
