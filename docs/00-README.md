...
| 8 | `08-implementation-roadmap.md` | 7-day plan, daily milestones, commits |
...
Once you've reviewed all nine and either approve or push back, we move to Phase 2 (Day 1 code). I will not generate implementation code before that approval.
